...
const generateProceduralNpc = (moral) => {
  ...
  const races = ["человек", "эльф", "нежить", "тролль", "каргахаулец", "изгнанник", "дух"];
  const classes = [
    "маг огня", "маг земли", "маг камня", "маг молнии", "маг огня и камня", 
    "маг молнии и земли", "некромант", "рунный маг", "маг света", "маг тьмы", 
    "маг бездны", "дикий рыцарь", "наемник военной банды", "бывший рыцарь", 
    "рыцарь-убийца", "рыцарь чумной стали", "отреченный паладин", "мятежник изгоев", 
    "головорез чумных земель", "каратель багрового ордена", "храмовник пепла", 
    "маг меток", "химомансер", "ментальный суверен", "плазмомансер", "странник", 
    "наемник", "купец", "целитель", "алхимик", "разведчик", "чернокнижник", 
    "пастух", "кузнец", "следопыт", "мародер", "инквизитор", "гробокопатель", 
    "травник", "хранитель костра", "вестник", "беглый каторжник", "охотник за головами", 
    "рыцарь крови", "схимник", "проводник в тумане", "летописец", "кандальщик", 
    "болотный охотник", "хранитель склепа", "рунный гравер", "чумной доктор", 
    "собиратель костей", "бродячий бард", "дозорный", "зверолов", "изгой пограничья", 
    "собиратель трав", "искатель реликвий", "маг печатей"
  ];
  const epithets = [
    "Слепой", "Хмурый", "Отрекшийся", "Бродячий", "Раненый", "Мудрый", "Падший", 
    "Молодой", "Старый", "Безумный", "Стойкий", "Забытый", "Дикий", "Безжалостный", 
    "Немой", "Одноглазый", "Изувеченный", "Мрачный", "Опальный", "Скитающийся", 
    "Смиренный", "Озлобленный", "Искупленный", "Молчаливый", "Проклятый", "Потерянный", 
    "Иссохший", "Жестокий", "Свирепый", "Суровый", "Скорбящий", "Бесприютный", 
    "Холодный", "Пепельный", "Костяной", "Ржавый", "Бледный", "Непокорный", 
    "Отреченный", "Теневой", "Болотный"
  ];
...
const LOCATION_BATTLE_BACKDROPS = {
  light: [
    "Над Изгнанником возвышаются сияющие стены форпоста Империи Света. Герой видит, как белые рыцари вешают на цепях беглого кандальщика, обвиненного во лжи.",
    "Сквозь золотистый туман слышен звон стали: отряд паладинов избивает безоружного селянина, заподозренного в сокрытии скверны.",
    "Путь преграждает патруль в ослепительно белых доспехах, собирающий пошлину. Изгнанник может обойти их по грязному рву, усеянному шипами.",
    "Изгнанник замечает раненого инквизитора Света, чью ногу придавило упавшим священным знаменем. Он молит о помощи, истекая кровью.",
    "У храмовых ворот жрецы раздают освященный хлеб толпе голодных беженцев, но бьют плетьми тех, кто берет без очереди.",
    "Стычка между верховыми рыцарями Света и болотным троллем на узкой мощеной дороге. Ошметки плоти летят на мраморные барельефы.",
    "Изгнанник замечает брошенную карету священнослужителя, увязшую в болоте. Вокруг лежат тела гвардейцев, а сундук с церковным золотом полуоткрыт.",
    "На обочине догорает костер. Рыцари Света привязали к столбу эльфийского разведчика, обвиняя его в шпионаже и ереси.",
    "Сквозь густые заросли светящегося терновника Изгнанник видит, как священник проводит ритуал очищения над кричащим от боли кандальщиком.",
    "Патруль Света гонится за воришкой, укравшим священную свечу. Беглец спотыкается прямо перед ногами Изгнанника.",
    "Над головой раздается грохот небесного шпиля. Обломки священных камней сыплются на дорогу, заставляя героя уклоняться.",
    "Изгнанник проходит мимо виселицы, где раскачиваются тела дезертиров в белых накидках. Под ними мародеры снимают сапоги.",
    "Вспышка священного пламени освещает чащу: паладин карает заблудшего духа, сжигая его эфирное тело.",
    "Отряд храмовников Света выстраивается в фалангу, прикрывая щитами проход от стаи голодных болотных псов.",
    "Изгнанник видит раненую целительницу Света, прислонившуюся к оскверненному алтарю. Она пытается перевязать разорванное плечо.",
    "Молодой рыцарь Света плачет над телом своего павшего скакуна. Его броня залита кровью, а шлем разбит.",
    "Повозка с провиантом Империи перевернулась. Солдаты яростно спорят, стоит ли бросить раненых ради спасения зерна.",
    "Изгнанник замечает, как старый жрец Света тайно прячет в дорожную сумку золотой кубок, украденный из собственного алтаря.",
    "Стычка на мосту: двое паладинов отбиваются от болотных тварей. Мост трещит, и один из них зависает над пропастью.",
    "Группа селян пытается прорвать кордон рыцарей Света, чтобы спасти свои семьи из карантинной зоны.",
    "Изгнанник натыкается на лагерь паладинов. Они пьяны, празднуют победу и заставляют пленного изгнанника танцевать на углях.",
    "Священное копье Света вонзено в землю, вокруг него тлеет трава. Изгнанник чувствует жар и силу, исходящую от артефакта.",
    "Беглый маг света пытается укрыться в придорожных кустах, его руки светятся неуправляемой магией.",
    "Рыцари Света допрашивают бродячего торговца, подозревая его в продаже отравленных зелий.",
    "Изгнанник проходит мимо огромного колокола Света, упавшего с колокольни. Под ним видны останки раздавленного солдата."
  ],
  borders: [
    "Изгнанник бредет сквозь густой серый туман Ничейных Земель. Под ногами хрустят кости тех, кто пытался пересечь этот проклятый рубеж.",
    "Сквозь туман доносится чавканье: стая диких гарпий пожирает останки патрульного отряда Империи Света.",
    "Путь преграждает полуразрушенный мост. На нем двое мародеров спорят из-за ржавого меча, не замечая Изгнанника.",
    "Изгнанник видит привязанного к дереву скелета, в черепе которого торчит ржавая стрела с черным оперением.",
    "Стычка у заброшенного колодца: банда наемников Каргахаула отбивается от болотного тролля.",
    "В тумане тускло горит костер. Бродячий купец пытается отбиться от троих одичавших кандальщиков.",
    "Изгнанник натыкается на брошенную военную повозку, нагруженную ржавым оружием и испорченной провизией.",
    "Раненый разведчик эльфов лежит в грязи, пытаясь доползти до укрытия. Его стрелы сломаны, а лук разбит.",
    "Сквозь дымку Изгнанник видит, как теневой маг проводит ритуал, призывая мелких духов для поиска ценностей.",
    "Изгнанник наступает на ржавый капкан, поставленный охотниками за головами на ничейных дорогах.",
    "В воздухе кружат стаи кровожадных гарпий, высматривая ослабших путников среди болотных кочек.",
    "Изгнанник видит одинокого слепого странника, который пытается нащупать дорогу посохом среди ядовитых испарений.",
    "Группа мародеров обыскивает тела павших солдат, споря о ценности помятых лат.",
    "Старый заброшенный склеп, дверь которого выбита. Изнутри доносятся шорохи и запах гнили.",
    "Одинокий болотный охотник свежует тушу болотного пса, поглядывая на Изгнанника с подозрением.",
    "В тумане раздается дикий крик: путник провалился в болотную трясину и медленно тонет.",
    "Изгнанник проходит мимо сгоревшего хутора. На пепелище сидит раненый селянин, обнимая мертвую собаку.",
    "Отряд наемников делит добычу у дороги, громко ругаясь и размахивая топорами.",
    "Стычка на каменистой тропе: трое дезертиров пытаются ограбить бродячего лекаря.",
    "Изгнанник натыкается на древний рунный камень, покрытый копотью и засохшей кровью.",
    "В тумане слышны тяжелые шаги болотного великана. Изгнаннику приходится затаить дыхание в зарослях.",
    "Сломанная катапульта Империи Света лежит в канаве, ее колеса обвиты колючей лозой.",
    "Раненый боевой пес скулит у тела своего погибшего хозяина-наемника, зализывая его раны.",
    "Мародер пытается снять золотое кольцо с пальца мертвого рыцаря, но палец распух, и он тянется за ножом.",
    "Изгнанник видит брошенный лагерь с котелком, в котором все еще кипит какая-то мутная похлебка."
  ],
  ndravn: [
    "Изгнанник вступает под золотые своды Обителей Ндравна. Воины в темных доспехах несут караул, с уважением приветствуя путника.",
    "На площади люди и разумная нежить совместно восстанавливают старинную библиотеку, бережно перенося древние манускрипты.",
    "Изгнанник видит, как рыцарь Ндравна делится плащом со старым странником, укрывая его от прохладного ветра.",
    "У источника Света жрица Ндравна омывает раны раненого эльфийского разведчика, тихо напевая песню мира.",
    "Патруль Ндравна сопровождает караван купцов, гарантируя безопасность каждому торговцу независимо от его расы.",
    "Изгнанник проходит мимо храма Воли, где люди и духи предков ведут тихую совместную медитацию.",
    "Два рыцаря — человек и разумный умертвие — с улыбкой спорят о тактике защиты стен, полируя свои мечи.",
    "Изгнанник замечает, как целитель Ндравна бесплатно раздает целебные настои нуждающимся беженцам.",
    "Светлая площадь озарена эфирным сиянием Ндравна. Бард играет на арфе, собрав вокруг толпу мирных жителей.",
    "Изгнанник видит, как стражники Ндравна помогают селянину починить сломавшуюся телегу с урожаем зерна.",
    "Рыцари Ндравна проводят тренировку. Их темные доспехи украшены золотыми лентами мира и единства.",
    "Изгнанник проходит мимо сада Примирения, где люди бережно ухаживают за редкими светящимися цветами.",
    "Молодой воин Ндравна приносит клятву верности защите слабых перед сияющим алтарем Единения.",
    "Отряд стражи Ндравна вежливо просит Изгнанника показать дорожную грамоту, желая ему безопасного пути.",
    "Изгнанник видит, как нежить в темных доспехах помогает испуганному ребенку найти дорогу домой.",
    "У костра сидят воины Ндравна разных рас, делясь хлебом и рассказывая истории о мирном сосуществовании.",
    "Изгнанник проходит мимо школы рунного мастерства, где старый маг обучает детей основам созидания.",
    "Стражники Ндравна аккуратно переносят раненого оленя, пострадавшего от браконьеров на границе.",
    "Эфирные духи парят над стенами Ндравна, укрепляя ментальные барьеры города против внешнего хаоса.",
    "Изгнанник замечает, как торговец Ндравна честно возвращает покупателю оброненный кошель с золотом.",
    "Рыцарь Ндравна бережно хоронит павшего в приграничной стычке воина, читая над ним молитву покоя.",
    "У ворот Обители стражи раздают теплую одежду и еду всем измученным беглецам из Диких Земель.",
    "Изгнанник видит мудрого правителя Ндравна, который лично выслушивает жалобы и споры мирных селян.",
    "Разумная нежить в латах бережно поливает саженец белого древа на центральной площади Ндравна.",
    "Изгнанник провожает взглядом величественных рыцарей Ндравна, отправляющихся на защиту мирных рубежей."
  ],
  empires: [
    "Изгнанник проходит по мощеной дороге Лоскутных Империй. Вокруг высятся гордые замки мелких людских королей.",
    "Стычка на границе двух княжеств: конные рыцари в синих плащах штурмуют заставу солдат в красных мундирах.",
    "Путь преграждает сборщик налогов с отрядом тяжелых арбалетчиков, требующий плату за проход по мосту княжества.",
    "Изгнанник видит прибитый к столбу указ очередного барона, объявляющий войну соседнему герцогству за пастбища.",
    "Отряд наемников лоскутной империи конвоирует пленных бунтовщиков в кандалах к замковой тюрьме.",
    "Стычка на лесной дороге: рыцари барона отбиваются от засады лесных разбойников.",
    "Изгнанник проходит мимо таверны, где вербуют добровольцев в армию короля под обещания золота и славы.",
    "Раненый вестник лоскутного королевства лежит у дороги, сжимая в руке окровавленное секретное письмо.",
    "Стража лоскутной империи обыскивает повозки торговцев, изымая «излишки провианта» на нужды грядущей войны.",
    "Изгнанник замечает дуэль двух дворян на шпагах прямо посреди пыльной придорожной площади.",
    "Рыцари лоскутной империи в тяжелых доспехах тренируются в конном строю, поднимая тучи пыли.",
    "Изгнанник видит, как глашатай на площади зачитывает приказ о принудительном наборе селян в ополчение.",
    "Отряд солдат лоскутного княжества делит отобранную у торговца бочку вина, громко распевая песни.",
    "Изгнанник проходит мимо кузницы, где день и ночь куют мечи и наконечники копий для армии барона.",
    "Раненый рыцарь лоскутной империи просит Изгнанника помочь ему снять помятый шлем, сдавливающий горло.",
    "Солдаты лоскутного короля допрашивают бродячего лекаря, обвиняя его в шпионаже в пользу герцогства.",
    "Изгнанник натыкается на перевернутую карету вельможи лоскутной империи, разграбленную дезертирами.",
    "Стражники лоскутного замка вешают на воротах вора, укравшего мешок овса из королевских амбаров.",
    "Стычка на узкой тропе: рыцарь лоскутного ордена требует, чтобы Изгнанник уступил ему дорогу.",
    "Два мелких лорда спорят у карты на пограничном столбе, готовые в любой момент схватиться за мечи.",
    "Изгнанник видит брошенные доспехи и разорванное знамя лоскутного королевства в придорожной канаве.",
    "Отряд арбалетчиков лоскутной империи занимает позиции на холме, готовясь к встрече вражеского авангарда.",
    "Раненый сержант людского ополчения пытается перевязать ногу разорванным знаменем своего барона.",
    "Изгнанник проходит мимо лагеря людских рыцарей, где они чистят свои доспехи и точат мечи.",
    "Пограничный патруль лоскутного княжества настороженно следит за Изгнанником со смотровой вышки."
  ],
  kargahaul: [
    "Изгнанник пробивается сквозь ледяную бурю Диких Перевалов Каргахаула. Здесь закон вершится только крепостью стали.",
    "Стычка на заснеженном склоне: каргахаульские наемники с тяжелыми топорами отбиваются от стаи ледяных волков.",
    "Путь преграждает каргахаульский заслон. Суровые воины в шкурах требуют плату за проход по горной тропе.",
    "Изгнанник видит замерзшее тело наемника, сжимающего в руках рукоять своего верного топора.",
    "Стычка у горного костра: банда диких звероловов делит добычу после успешной охоты на ледяного тролля.",
    "В метели тускло горит костер. Каргахаульский кузнец кует горное снаряжение прямо под открытым небом.",
    "Изгнанник натыкается на брошенный лагерь каргахаульских наемников, занесенный снегом и льдом.",
    "Раненый каргахаульский разведчик лежит на снегу, пытаясь зажать рану на груди ледяным крошевом.",
    "Сквозь метель Изгнанник видит, как дикий шаман проводит ритуал очищения оружия над телами павших.",
    "Изгнанник наступает на скрытую под снегом ледяную трещину, едва успевая удержаться на краю пропасти.",
    "В ледяном небе кружат горные гарпии, высматривая замерзающих путников среди скалистых ущелий.",
    "Изгнанник видит одинокого каргахаульского следопыта, выслеживающего добычу по глубоким следам на снегу.",
    "Группа диких наемников обыскивает тела замерзших солдат, забирая теплую меховую одежду.",
    "Одинокий каргахаульский воин тренируется на ледяном ветру, нанося мощные удары по каменной глыбе.",
    "Раненый каргахаульский боевой пес греет своим телом замерзающего хозяина-наемника в метели.",
    "Изгнанник проходит мимо ледяного алтаря Каргахаула, украшенного черепами диких горных тварей.",
    "Отряд каргахаульских воинов штурмует укрепленную пещеру, где засели болотные гоблины.",
    "Стычка на обледенелом мосту: каргахаульские наемники отбиваются от ледяных тварей Бездны.",
    "Изгнанник натыкается на перевернутые сани каргахаульских купцов, застрявшие в глубоком сугробе.",
    "Раненый каргахаульский сержант пытается доползти до костра, оставляя на белом снегу багровый след.",
    "Каргахаульский патруль настороженно следит за Изгнанником с вершины заснеженного утеса.",
    "Стычка у горного источника: каргахаульские наемники спорят с эльфийским разведчиком из-за воды.",
    "Изгнанник проходит мимо каргахаульской заставы, где воины пьют крепкий эль и точат свои секиры.",
    "Раненый каргахаульский кузнец пытается починить сломанный щит, грея руки над угасающими углями.",
    "Суровый каргахаульский вождь провожает Изгнанника тяжелым взглядом, держа руку на эфесе меча."
  ],
  undead: [
    "Изгнанник вступает под сень Мертвых Земель. Воздух пропитан ядовитым туманом и сладковатым запахом тлена.",
    "Стычка на оскверненном кладбище: вампиры в багровых плащах сражаются с карательным отрядом Багрового Ордена.",
    "Путь преграждает шествие темного культа. Культисты в черных балахонах несут гроб, усеянный человеческими черепами.",
    "Изгнанник видит восставшего из могилы мертвеца, безуспешно пытающегося разорвать свои ржавые кандалы.",
    "Стычка у разрушенного склепа: некромант призывает скелетов, чтобы отбиться от болотного тролля.",
    "В фиолетовом сумраке Мертвых Земель горит бледный огонь. Чумной доктор собирает кости павших рыцарей.",
    "Изгнанник натыкается на разграбленный караван целителей, чьи тела превращены в зомби силами тьмы.",
    "Раненый инквизитор Света лежит среди могил, сжимая в руке сломанный светящийся крест.",
    "Сквозь ядовитый туман Изгнанник видит, как вампир пьет кровь пленного каргахаульского наемника.",
    "Изгнанник замечает древний склеп вампиров, из открытых дверей которого веет леденящим могильным холодом.",
    "В темном небе кружат летучие мыши-переростки, высматривая живую плоть среди иссохших деревьев.",
    "Изгнанник видит одинокого бродячего некроманта, читающего заклинания над свежей могилой.",
    "Группа диких гулей обгладывает кости павших солдат у дороги, яростно рыча и дерясь за куски плоти.",
    "Одинокий рыцарь чумной стали медленно бредет по дороге, волоча за собой ржавый двуручный меч.",
    "Раненый эльфийский маг меток пытается защититься барьером от наступающей орды иссохшей нежити.",
    "Изгнанник проходит мимо оскверненного храма Света, превращенного культистами в алтарь жертвоприношений.",
    "Отряд Багрового Ордена штурмует башню некроманта, осыпая ее горящими стрелами и священной водой.",
    "Стычка на гнилом болоте: вампиры отбиваются от наводнивших Мертвые Земли диких тварей Бездны.",
    "Изгнанник натыкается на брошенную повозку гробокопателя, наполненную человеческими костями и черепами.",
    "Раненый темный рыцарь пытается перевязать рану черным саваном, шепча проклятия своим создателям.",
    "Патруль нежити в ржавых доспехах медленно марширует по каменистой тропе, гремя костями.",
    "Стычка у кровавого источника: культисты пытаются принести в жертву пленного ополченца.",
    "Изгнанник проходит мимо склепа, из глубин которого доносятся жуткие крики и скрежет цепей.",
    "Раненый собиратель костей пытается починить свою сумку, наполненную древними артефактами тьмы.",
    "Суровый вампир-рыцарь провожает Изгнанника ледяным взглядом с вершины оскверненного кургана."
  ],
  chaos: [
    "Изгнанник ступает на пылающие Пустоши Хаоса. Фиолетовая плазма разрывает небеса, а земля трещит под ногами.",
    "Стычка в искаженном пространстве: демоны хаоса сражаются с отрядом обезумевших каргахаульских наемников.",
    "Путь преграждает поток кипящей лавы, в которой плавают обломки древних рунных плит.",
    "Изгнанник видит мутировавшее существо Бездны, которое безуспешно пытается вырваться из пространственной петли.",
    "Стычка у пылающего разлома: плазмомансер отбивается от орды мелких бесов Бездны.",
    "В фиолетовом пламени Хаоса горит придорожный указатель, указывающий дорогу в несуществующие города.",
    "Изгнанник натыкается на лагерь обезумевших сектантов, совершивших массовое самосожжение во имя Бездны.",
    "Раненый ментальный суверен лежит на растрескавшейся земле, сжимая голову руками от невыносимого шепота.",
    "Сквозь фиолетовый дым Изгнанник видит, как порождение Хаоса пожирает эльфийского мага.",
    "Изгнанник замечает древний алтарь Хаоса, излучающий мощные волны ментального безумия.",
    "В небе Хаоса летают огромные плазменные скаты, испуская мощные электрические разряды в землю.",
    "Изгнанник видит одинокого чернокнижника хаоса, пытающегося подчинить своей воле блуждающий огонек.",
    "Группа мутировавших болотных гоблинов дерется за кусок светящегося эфирного кристалла.",
    "Одинокий рыцарь чумной стали стоит на краю лавового озера, вглядываясь в пылающую бездну.",
    "Раненый маг бездны пытается закрыться энергетическим куполом от бьющих из земли плазменных гейзеров.",
    "Изгнанник проходит мимо огромного кристалла Хаоса, внутри которого виден застывший силуэт рыцаря Света.",
    "Отряд карателей Багрового Ордена ведет обреченный бой против превосходящих сил порождений Бездны.",
    "Стычка на парящем острове земли: безумные культисты пытаются сбросить пленного наемника в пропасть.",
    "Изгнанник натыкается на перевернутую повозку химомансера, из которой выливается едкая зеленая жижа.",
    "Раненый дикий рыцарь пытается остановить кровотечение с помощью прижигания раны чистой плазмой.",
    "Патруль хаоса — искаженные полупрозрачные силуэты — медленно парит над растрескавшейся землей.",
    "Стычка у пространственного разлома: обезумевшие селяне пытаются закрыть портал своими телами.",
    "Изгнанник проходит мимо пещеры Хаоса, из которой доносится потусторонний смех и скрежет металла.",
    "Раненый плазмомансер пытается восстановить свои силы, впитывая энергию из пролетающих мимо искр.",
    "Суровый лорд Хаоса провожает Изгнанника горящим взглядом из-за завесы фиолетового пламени."
  ]
};
...
export default function CarriageSession({ 
  ...
  const handleGenerateResolutionChronicle = async (type, task, enemy, isAmbush = false, npcName = '') => {
    ...
    // Calculate current location in kilometers to resolve context-dependent battle backdrops (25 per region)
    ...
    let currentLocId = "light";
    if (kilometers >= 20 && kilometers < 50) {
      currentLocId = "borders";
    } else if (kilometers >= 50) {
      if (moralVal >= 80) currentLocId = "ndravn";
      else if (moralVal >= 60) currentLocId = "empires";
      else if (moralVal >= 40) currentLocId = "kargahaul";
      else if (moralVal >= 20) currentLocId = "undead";
      else currentLocId = "chaos";
    }

    const backdrops = LOCATION_BATTLE_BACKDROPS[currentLocId] || LOCATION_BATTLE_BACKDROPS.borders;
